...
describe('Trade', () => {
  ...
  it('can be constructed with CAVAX as input', () => {
  ...
  it('can be constructed with CAVAX as input for exact output', () => {
    const trade = new Trade(
  ...
  it('can be constructed with CAVAX as output', () => {
    const trade = new Trade(
  ...
  it('can be constructed with CAVAX as output for exact input', () => {
    const trade = new Trade(
      new Route([pair_weth_0], token0, CAVAX),
      new TokenAmount(token0, JSBI.BigInt(100)),
      TradeType.EXACT_INPUT,
  ...
  describe('#bestTradeExactIn', () => {
    ...
    it('works for CAVAX currency input', () => {
      const result = Trade.bestTradeExactIn(
    ...
    it('works for CAVAX currency output', () => {
      const result = Trade.bestTradeExactIn(
        [pair_weth_0, pair_0_1, pair_0_3, pair_1_3],
